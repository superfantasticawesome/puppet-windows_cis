Facter.add("domain_role") do
  ...
  setcode do
    standalone_server = Facter::Util::Resolution.exec('C:\Windows\system32\WindowsPowerShell\v1.0\powershell.exe -Command ($Env:Computername -eq $Env:Userdomain).ToLower()')
